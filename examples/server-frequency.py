'''
 ...
 examples/server-frequency.py - Copyright 2023 Harshad Joshi and Bufferstack.IO Analytics Technology LLP, Pune
...
def predict():
    ...
    new_data = pd.DataFrame({'pulse': [data['pulse']], 'spikes': [data['spikes']]})

    # Check for missing values and infinite values in new_data
    fill_missing_values(new_data)
    handle_infinite_values(new_data, ['pulse', 'spikes'])
